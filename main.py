...
# Create players
jake = Player('Jake', StrategyOptions.HI_LOW_COUNT, money=50000, standard_bet=25, play_as=False)
kyle = Player('Kyle',StrategyOptions.BASIC,money=100,standard_bet=5,play_as=False)

# Create table
t = Table([jake],num_decks=1,shoe_shuffle_depth=0,min_bet=5,max_bet=10000,
