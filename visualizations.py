...
def strategy_comparison(players,x_series,title = 'Strategy Comparison',filename_base='one_table_one_player',save=False):
    ...
    for i, player in enumerate(players):
        plt.plot(x_series, player.sim_results.percentile_sim_results[50])
